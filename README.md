# Lachesis, A theme for [Hugo](http://gohugo.io/), a framework for building websites.

The intent of this theme is to provide a solid starting place for Hugo sites with basic features and include best practices for performance, accessibility, and rapid development.

![screenshot](https://raw.githubusercontent.com/ajduncan/gohugo-theme-lachesis/master/images/screenshot.png)

[DEMO](https://gohugo-lachesis-theme-demo.netlify.com/)
...
Inside the folder of your Hugo site run:
    ...
    $ cd themes
    $ git clone https://github.com/ajduncan/gohugo-theme-lachesis.git
...
Take a look inside the [`exampleSite`](https://github.com/ajduncan/gohugo-theme-lachesis/tree/master/exampleSite) folder of this theme. You'll find a file called [`config.toml`](https://github.com/ajduncan/gohugo-theme-lachesis/blob/master/exampleSite/config.toml). To use it, copy the [`config.toml`](https://github.com/ajduncan/gohugo-theme-lachesis/blob/master/exampleSite/config.toml) in the root folder of your Hugo site. Feel free to change the strings in this theme.
...
If you find a bug or have an idea for a feature, feel free to use the [issue tracker](https://github.com/ajduncan/gohugo-theme-lachesis/issues) to let me know.
